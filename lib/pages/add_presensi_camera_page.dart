import 'package:attendio_mobile/utils/face_detector/detector_view.dart';
import 'package:attendio_mobile/utils/face_detector/face_detector_painter.dart';
...
class _AddPresensiCameraPageState extends State<AddPresensiCameraPage> {
  ...
  Future<void> _processImage(InputImage inputImage) async {
    ...
    if((faces.isNotEmpty && !_faceDetected) || (faces.isEmpty && _faceDetected)) {
      setState(() {
